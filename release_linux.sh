...
OUTFILE_GENERIC="nq-linux-${PACKAGE_VERSION_NO_WHITESPACE}.tar.gz"
OUTFILE_HIVEOS="nq-${PACKAGE_VERSION_NO_WHITESPACE}.tar.gz"
OUTDIR_SMOS="nq-${PACKAGE_VERSION_NO_WHITESPACE}"
OUTFILE_SMOS="nq-${PACKAGE_VERSION_NO_WHITESPACE}.zip"
